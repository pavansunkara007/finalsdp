...
export class BookingComponent implements OnInit {
  ...
  doctors=[
    ...
    {name:"Dr.V Srinivas", sp:"Neurologist", qua:"MBBS,MD, DM Neuro",hosp:"NIMS Hospital, Hyderabad", exp:"22years"},
    {name:"Dr.K SaiReddy", sp:"Cardioligist", qua:"MBBS,MD, DM Neuro",hosp:"KIMS Hospital, Hyderabad", exp:"12years"},
    {name:"Dr.G Vamsi Mitra", sp:"Physio Therapist", qua:"MBBS,MD, DM Neuro",hosp:" Sree Physiocare, Hyderabad", exp:"20years"},
    {name:"Dr.Hari", sp:"Dentist", qua:"BDS, MDS",hosp:"Clove Hospital, Bangalore", exp:"12years"},
  ]
}
