...
export class SearchOrgansComponent implements OnInit {
  ...
  doctors=[
    ...
    {name:"Metabolic Panel Test", sp:"cardialogist", qua:"MBBS,MD",hosp:"Harsha Labs,Health Care Diagnostics", exp:"Rs.2000"},
    {name:"Comprehensive Metabolic Pane Test", sp:"pediatrician", qua:"MBBS,MD",hosp:"Appollo Diagnostics", exp:"Rs.1515"},
    {name:"Lipid profile test", sp:"psychiatrist", qua:"MBBS,MD",hosp:"Lasya Diagnostics, Alpha labs", exp:"Rs.299"},
    ...
    {name:"Insulin Test", sp:"pediatrician", qua:"MBBS,MD",hosp:"Shreya Labs", exp:"Rs.350"},
